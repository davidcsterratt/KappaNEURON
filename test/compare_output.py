...
ax[0][0].plot(tcp['t'], tcp['cai'])
ax[0][0].set_xlabel("Time [ms]")
ax[0][0].set_ylabel("Ca [mM]")
ax[0][0].axis(ymin=-1E-2, ymax=0.5E-1)

ax[1][0].plot(tcp_mod['t'], tcp_mod['cai'])
ax[1][0].set_xlabel("Time [ms]")
ax[1][0].set_ylabel("Ca [mM]")
ax[1][0].axis(ymin=-1E-2, ymax=0.5E-1)

ax[2][0].plot(tcp_mod['t'], tcp_mod['cai'] - tcp['cai'])
ax[2][0].set_xlabel("Time [ms]")
ax[2][0].set_ylabel("Ca [mM]")
ax[2][0].axis(ymin=-3E-2, ymax=3E-2)

ax[0][1].plot(tcp['t'], tcp['Pi'])
ax[0][1].set_xlabel("Time [ms]")
ax[0][1].set_ylabel("P [mM]")
ax[0][1].axis(ymin=-1E-2, ymax=3E-1)

ax[1][1].plot(tcp_mod['t'], tcp_mod['Pi'])
ax[1][1].set_xlabel("Time [ms]")
ax[1][1].set_ylabel("P [mM]")
ax[1][1].axis(ymin=-1E-2, ymax=3E-1)

ax[2][1].plot(tcp_mod['t'], tcp_mod['Pi'] - tcp['Pi'])
ax[2][1].set_xlabel("Time [ms]")
ax[2][1].set_ylabel("P [mM]")
ax[2][1].axis(ymin=-3E-2, ymax=3E-2)
